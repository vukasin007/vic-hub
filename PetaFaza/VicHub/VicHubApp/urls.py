...
urlpatterns = [
    ...
    path('accept_mod_request/<int:request_id>', accept_mod_request, name='accept_mod_request'),  # vukasin007 merge into one
    path('reject_mod_request/<int:request_id>', reject_mod_request, name='reject_mod_request'),  # vukasin007 merge into one
