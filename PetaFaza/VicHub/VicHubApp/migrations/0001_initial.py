    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birth', models.DateField(default=datetime.datetime(2022, 6, 8, 21, 11, 20, 162012))),
                ('subscribed', models.CharField(max_length=1)),
                ('status', models.CharField(max_length=1)),
                ('type', models.CharField(max_length=1)),
                ('date_of_promotion', models.DateTimeField(default=datetime.datetime(2022, 6, 8, 21, 11, 20, 162011))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(2022, 6, 8, 21, 11, 20, 165011))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_category', models.ForeignKey(db_column='id_category', on_delete=django.db.models.deletion.DO_NOTHING, to='VicHubApp.category')),
                ('id_joke', models.ForeignKey(db_column='id_joke', on_delete=django.db.models.deletion.DO_NOTHING, to='VicHubApp.joke')),
            ],
            options={
                'db_table': 'belongs_to',
